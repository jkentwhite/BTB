...
//    //to trigger RFID task number one
//    //if (key == '1') {
//    //  rfidOneTriggered = true;
//    //}
//    //to trigger RFID task number two and shut off lasers
//    //if (key == '2') {
//    //  rfidTwoTriggered = true;
//    //}
    
//    //to move out of laserPuzzle into floorGrid PRESS Z
//    if (key == 'z' || key == 'Z') {
//      laserPuzzle = false;
...
//    //    if(b == null || b.centerOfBlobY < 0 || b.centerOfBlobY > 768){
//    //      emptySpace = true;
//    //      } else {
//    //        emptySpace = false;
//    //      }   
...
//    //  if (b.centerOfBlobY > 0 && b.centerOfBlobY < 185) {
//    //    rowOne = true;
//    //  } else {
//    //    rowOne = false;
//    //  }
...
//  //text("row 1: " + rowOne, width/4, height/5);
//  //text("row 2: " + rowTwo, width/4, height/5*2);
//  //text("row 3: " + rowThree, width/4, height/5*3);
//  //text("row 4: " + rowFour, width/4, height/5*4);
