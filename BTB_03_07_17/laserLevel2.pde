...
int [] [] activeReceptorsGS3 = {
  ...
  { }, //0
  {1, 2, 3, 5, 6, 7, 8, 10, 11, 14}, //1
  {0, 2, 3, 5, 6, 7, 8, 10, 11, 14}, //2
  {0, 1, 3, 5, 6, 7, 8, 10, 11, 14}, //3
  {0, 1, 2, 3, 5, 6, 7, 8, 10, 11, 14}, //4
  {0, 1, 2, 3, 5, 6, 7, 8, 10, 11, 14}, //5
  {0, 1, 2, 3, 6, 7, 8, 10, 11, 14}, //6
  {0, 1, 2, 3, 5, 7, 8, 10, 11, 14}, //7
  {0, 1, 2, 3, 5, 6, 8, 10, 11, 14}, //8
  {0, 1, 2, 3, 5, 6, 7, 10, 11, 14}, //9
  {0, 1, 2, 3, 6, 5, 7, 8, 10, 11, 14}, //10
  {0, 1, 2, 3, 5, 6, 7, 8, 11, 14}, //11
  {0, 1, 2, 3, 5, 6, 7, 8, 10, 14}, //12
  {0, 1, 2, 3, 5, 6, 7, 8, 10, 11, 14},   //13
  {0, 1, 2, 3, 5, 6, 7, 8, 10, 11, 14},   //14
  {0, 1, 2, 3, 5, 6, 7, 8, 10, 11, 14},   //15
...
int [] [] activeReceptorsGS4 = {
  ...
  { }, //0
  {2, 3, 4, 5, 6, 7, 8, 10, 11, 12, 13}, //1
  {0, 2, 3, 4, 5, 6, 7, 8, 10, 11, 12, 13}, //2
  {0, 3, 4, 5, 6, 7, 8, 10, 11, 12, 13}, //3
  {0, 2, 4, 5, 6, 7, 8, 10, 11, 12, 13}, //4
  {0, 2, 3, 5, 6, 7, 8, 10, 11, 12, 13}, //5
  {0, 2, 3, 4, 6, 7, 8, 10, 11, 12, 13}, //6
  {0, 2, 3, 4, 5, 7, 8, 10, 11, 12, 13}, //7
  {0, 2, 3, 4, 5, 6, 8, 10, 11, 12, 13}, //8
  {0, 2, 3, 4, 5, 6, 7, 10, 11, 12, 13}, //9
  {0, 2, 3, 4, 6, 5, 7, 8, 10, 11, 12, 13}, //10
  {0, 2, 3, 4, 5, 6, 7, 8, 11, 12, 13}, //11
  {0, 2, 3, 4, 5, 6, 7, 8, 10, 12, 13}, //12
  {0, 2, 3, 4, 5, 6, 7, 8, 10, 11, 13},   //13
...
int [] [] activeReceptorsGS5 = {
  ...
  {0, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14}, //2
  {0, 3, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14}, //3
  {0, 2, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14}, //4
  {0, 2, 3, 5, 6, 8, 9, 10, 11, 12, 13, 14}, //5
  {0, 2, 3, 4, 6, 8, 9, 10, 11, 12, 13, 14}, //6
  {0, 2, 3, 4, 5, 8, 9, 10, 11, 12, 13, 14}, //7
  {0, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14}, //8
  {0, 2, 3, 4, 5, 6, 9, 10, 11, 12, 13, 14}, //9
  {0, 2, 3, 4, 6, 5, 9, 8, 10, 11, 12, 13, 14}, //10
  {0, 2, 3, 4, 5, 6, 9, 8, 11, 12, 13, 14}, //11
  {0, 2, 3, 4, 5, 6, 9, 8, 10, 12, 13, 14}, //12
  {0, 2, 3, 4, 5, 6, 9, 8, 10, 11, 13, 14},   //13
  {0, 2, 3, 4, 5, 6, 9, 8, 10, 11, 12, 14},   //14
  {0, 2, 3, 4, 5, 6, 9, 8, 10, 11, 12, 13},   //15
...
int [] [] activeReceptorsGS6 = {
  ...
  { }, //0
  {2, 4, 6, 7, 8, 9, 10, 11, 12, 13, 14}, //1
  {2, 4, 6, 7, 8, 9, 10, 11, 12, 13, 14}, //2
  {1, 4, 6, 7, 8, 9, 10, 11, 12, 13, 14}, //3
  {1, 2, 4, 6, 7, 8, 9, 10, 11, 12, 13, 14}, //4
  {1, 2, 6, 7, 8, 9, 10, 11, 12, 13, 14}, //5
  {1, 2, 4, 6, 7, 8, 9, 10, 11, 12, 13, 14}, //6
  {1, 2, 4, 7, 8, 9, 10, 11, 12, 13, 14}, //7
  {1, 2, 4, 6, 7, 8, 9, 10, 11, 12, 13, 14}, //8
  {1, 2, 4, 6, 7, 9, 10, 11, 12, 13, 14}, //9
  {1, 2, 4, 6, 7, 9, 8, 10, 11, 12, 13, 14}, //10
  {1, 2, 4, 6, 7, 9, 8, 11, 12, 13, 14}, //11
  {1, 2, 4, 6, 7, 9, 8, 10, 12, 13, 14}, //12
  {1, 2, 4, 6, 7, 9, 8, 10, 11, 13, 14},   //13
  {1, 2, 4, 6, 7, 9, 8, 10, 11, 12, 14},   //14
  {1, 2,4, 6, 7, 9, 8, 10, 11, 12, 13},   //15
